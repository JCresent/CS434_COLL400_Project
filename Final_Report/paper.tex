...
\begin{enumerate}
  ...
  \item The graphs, maps, and other visuals help to display all of the models predictability towards actual website targets and helps to see the effectiveness of each. 
\end{enumerate}
...
\begin{figure}[!h]
  ...
  \caption{KNN Predictions Scatterplot}
...
\begin{figure}[!h]
  ...
  \caption{Random Forest Predictions Scatterplot}
